...
<div class="container">
  ...
  <div class="card">
    <div class="card-body">
      <h1><i class="fas fa-book-open"></i> Buku saya</h1>
      <br>
        ...
        $query=mysqli_query($connect,"select * from buku where ket = 'tidak tersedia'");
        $no=0;
        $data;
        ...
        <form action='include/pinjam-buku.php' method='post'>
        <input type='hidden' name='id' class='form-control' value='$data[id]'>
        <input type='hidden' name='nama' class='form-control' value='$data[nama]'>
        <input type='hidden' name='jenis' class='form-control' value='$data[jenis]'>
        <input type='hidden' name='penerbit' class='form-control' value='$data[penerbit]'>
        <input type='hidden' name='ket' class='form-control' value='tersedia'>
        <button type='submit' name='tersedia' class='btn btn-primary'>Kembalikan</button></form>
        </td>
        </tr>
        </tbody>";
        }
