...
<div class="card">
  <div class="card-body">
    <h3>Sistem Perpustakaan Sederhana created by Rizky Alam</h3>
    <p>Sistem ini dibuat menggunakan PHP dan Bootstrap 4.</p>
    <p>Masih banyak kekurangan dari sistem perpustakaan ini diharapkan saran nya supaya menjadi lebih baik lagi kedepan nya</p>
  </div>
</div>
</div>
<!-- Footer -->
