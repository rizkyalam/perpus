...
<div class="container">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Kelola pengurus</li>
    </ol>
  </nav>
  <div class="card">
    <div class="card-body">
      <h1><i class="fa fa-user"></i> Kelola Pengurus</h1>
      <br>
        <label><a href="kelola-pengurus/input.php">Tambah Pengurus</a></label>
        ...
        $query=mysqli_query($connect,"select * from users where peran = 'admin'");
        $no=0;
        $data;
        ...
        <td class='organisationnumber'><center>$data[uidUser] </td>
        <td class='organisationname'><center>$data[email] </td>
        <td class='organisationname'><center>
        <a href='delete-pengurus.php?id=$data[id]'
