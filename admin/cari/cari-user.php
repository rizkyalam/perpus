...
<div class="container">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="../cari.php">Cari</a></li>
      <li class="breadcrumb-item active" aria-current="page">Cari user</li>
    </ol>
  </nav>
  <div class="card">
    <div class="card-body">
      <form class="form-inline" action="cari-user.php" method="post">
  <input class="form-control mr-sm-2" name="search" placeholder="Cari user..." aria-label="Search" autocomplete="off">
  <button class="btn btn-outline-success my-2 my-sm-0" name="submit-anggota">Search</button>
      ...
      <br>
        ...
        require '../../include/koneksi.php';
          $search = $_POST['search'];
          $sql = "Select * from users where uidUser like '%$search%' or email '%$search%' and peran like 'pengguna'";
          $result = mysqli_query($connect, $sql) or die ('database error');
            ...
            while($row = mysqli_fetch_assoc($result)){
             ...
             <td class='organisationnumber'><center>$row[uidUser] </td>
             <td class='organisationname'><center>$row[email] </td>
