  ...
  <div class="card">
    <div class="card-body">
      ...
      <br>
        ...
        <td class='organisationname'><center>$data[ket] </td>
        ...
        <input type='hidden' name='ket' class='form-control' value='tidak tersedia'>
        <button type='submit' name='gk' class='btn btn-danger'>Pinjam</button></form>
        </td>
        </tr>
        </tbody>";
        }
